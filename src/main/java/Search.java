...
public class Search {
    ...
    public static void main(String[] args) {
        try {
            ...
            ServerS = new ServerSocket(3838, 100);
            ...
            if (num_account != 0) {
                List<Account> objectList = Arrays.asList(mapper.readValue(new File("Account.json"), Account[].class));
                int i = 0;
            ...
            bra.close();
            FileInputStream fism = new FileInputStream("Music.txt");
            ...
            if (num_music != 0) {
                List<Music> objectListMusic = Arrays.asList(mapper.readValue(new File("Music.json"), Music[].class));
                int i = 0;
